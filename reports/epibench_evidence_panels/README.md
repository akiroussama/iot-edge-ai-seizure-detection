...
- Claim distribution: `E1=6, E2-PD=2, E2-PI=5, E3=2, E4=1`.
- Dataset tier distribution: `T1=13, T2=1, T3=2`.
- Rank interpretation distribution: `claim_gate_promotes_more_defensible_evidence=5, claim_structure_valid_but_performance_poor=2, high_or_mid_score_claim_limited_by_evidence_gate=6, rank_stable_under_claim_gate=3`.
