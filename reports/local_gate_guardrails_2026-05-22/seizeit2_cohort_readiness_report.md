...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| blocked | blocked_not_full_cohort_ready | not_started | not_started | 1 | 2 | 1 | 0 | 20 | 1 | seizeit2_cohort_readiness_pre_gate_c_not_citable |

## Blockers

| issue_code | severity | detail | affected_rows | claim_status |
| --- | --- | --- | --- | --- |
| gate_b_not_passed | blocker | Gate B status is 'not_started'; human label audit is not complete. |  | seizeit2_cohort_readiness_pre_gate_c_not_citable |
