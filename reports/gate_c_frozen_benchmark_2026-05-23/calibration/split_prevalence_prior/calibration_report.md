...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| split_prevalence_prior | model | 10309 | 1418 | 373 | 0.2630465444287729 | 0.4754971590909091 | 0.23898832356317398 | 0.21245061466213622 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| split_prevalence_prior | split_prevalence_prior | 0.23898832356317398 | 0.23898832356317398 | 0.0 | 0.21245061466213622 | 0.21245061466213622 | 1418 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| split_prevalence_prior | model | 0 | 0.0 | 0.1 | 0 | nan | nan |
| split_prevalence_prior | model | 1 | 0.1 | 0.2 | 0 | nan | nan |
| split_prevalence_prior | model | 2 | 0.2 | 0.30000000000000004 | 0 | nan | nan |
| split_prevalence_prior | model | 3 | 0.30000000000000004 | 0.4 | 0 | nan | nan |
| split_prevalence_prior | model | 4 | 0.4 | 0.5 | 1418 | 0.4754971590909091 | 0.2630465444287729 |
| split_prevalence_prior | model | 5 | 0.5 | 0.6000000000000001 | 0 | nan | nan |
| split_prevalence_prior | model | 6 | 0.6000000000000001 | 0.7000000000000001 | 0 | nan | nan |
| split_prevalence_prior | model | 7 | 0.7000000000000001 | 0.8 | 0 | nan | nan |
| split_prevalence_prior | model | 8 | 0.8 | 0.9 | 0 | nan | nan |
| split_prevalence_prior | model | 9 | 0.9 | 1.0 | 0 | nan | nan |
