...
def test_sensitivity_at_fixed_time_in_warning_returns_budgeted_threshold():
    ...
    result = sensitivity_at_fixed_time_in_warning(preds, events, 2, 5, 0.5, thresholds=[0.0, 0.5])
...
def test_threshold_sweep_table_and_constraint_selection():
    ...
    sweep = threshold_sweep_table(preds, events, 2, 5, thresholds=[0.0, 0.5, 0.9, 1.0])
